...
import { loadParsingRules, serializeCsvRow } from "../core/src/utils/parseCsvFields";
...
if (!tenantArg || !pageId) {
  throw new Error(
    "Usage: --tenant <domain|path> --page_id <id> [--primary_keyword <kw>] [--offer_id <id>] [--page_type <type>] [--intent <intent>] [--language <code>] [--region <id>]"
  );
}
